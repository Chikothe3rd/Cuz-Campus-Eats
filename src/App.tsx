...
import OrderDetailTracking from "./pages/buyer/OrderDetailTracking";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/buyer/orders/:orderId" element={<OrderDetailTracking />} />
            
            {/* Runner Routes */}
            <Route path="/runner" element={<RunnerDashboard />} />
            <Route path="/runner/orders/:orderId" element={<OrderDetailTracking />} />
            
            {/* Vendor Routes */}
            <Route path="/vendor" element={<VendorDashboard />} />
            <Route path="/vendor/setup" element={<VendorSetup />} />
            <Route path="/vendor/menu" element={<VendorMenu />} />
            <Route path="/vendor/orders/:orderId" element={<OrderDetailTracking />} />
